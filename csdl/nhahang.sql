...
CREATE TABLE IF NOT EXISTS `nhahang` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id của nhà hàng',
  `ten` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'tên nhà hàng',
  `dia_chi` varchar(1000) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'địa chỉ, để dạng json',
  `tom_tat` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'tóm tát ngắn gọn về các đặc điểm nổi bật của nhà hàng',
  `anh_dai_dien` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'ảnh đại diện cho nhà hàng này',
  `album` varchar(1000) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'lưu danh sách các link ảnh, json',
  `menu` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'menu của nhà hàng này, json',
  `mo_ta` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'mô tả về nhà hàng này, json',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='nhà hàng' AUTO_INCREMENT=39 ;

--
-- Dumping data for table `nhahang`
--

INSERT INTO `nhahang` (`id`, `ten`, `dia_chi`, `tom_tat`, `anh_dai_dien`, `album`, `mo_ta`, `kinh_do`, `vi_do`, `tag`, `viewcount`, `ratecount`, `ratescore`, `rate`, `tien_do`) VALUES
