...
--
-- Table structure for table `khuvuichoigiaitri`
--

CREATE TABLE IF NOT EXISTS `khuvuichoigiaitri` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id của khu vui chơi giải trí',
  `ten` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'tên khu vui chơi giải trí',
  `dia_chi` varchar(1000) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'địa chỉ, để dạng json',
  `tom_tat` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'tóm tát ngắn gọn về các đặc điểm nổi bật của khu vui chơi giải trí',
  `anh_dai_dien` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'ảnh đại diện cho khu vui chơi giải trí này',
  `album` varchar(1000) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'lưu danh sách các link ảnh, json',
  `mo_ta` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'mô tả về khu vui chơi giải trí này, json',
  `kinh_do` float NOT NULL,
  `vi_do` float NOT NULL,
  `tag` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'danh sách các id tag, json',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='khu vui chơi giải trí' AUTO_INCREMENT=39 ;

--
-- Dumping data for table `khuvuichoigiaitri`
--

INSERT INTO `khuvuichoigiaitri` (`id`, `ten`, `dia_chi`, `tom_tat`, `anh_dai_dien`, `album`, `mo_ta`, `kinh_do`, `vi_do`, `tag`, `viewcount`, `ratecount`, `ratescore`, `rate`, `tien_do`) VALUES
