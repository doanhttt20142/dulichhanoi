...
CREATE TABLE IF NOT EXISTS `diemden` (
  ...
  `ten` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'tên điểm đến',
  `dia_chi` varchar(1000) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'địa chỉ, để dạng json',
  `tom_tat` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'tóm tát ngắn gọn về các đặc điểm nổi bật của điểm đến',
  `anh_dai_dien` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'ảnh đại diện cho điểm đến này',
  `album` varchar(1000) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'lưu danh sách các link ảnh, json',
  `mo_ta` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'mô tả về điểm đến này, json',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='điểm đến' AUTO_INCREMENT=39 ;
